...
#[derive(Debug)]
pub struct ApiUtilityProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ApiUtilityProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ApiUtility processing");
    
    let mut processor = ApiUtilityProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ApiUtilityProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ApiUtilityProcessor::new(false);
